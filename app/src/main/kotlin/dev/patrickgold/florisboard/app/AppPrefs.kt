...
abstract class FlorisPreferenceModel : PreferenceModel() {
    ...
    inner class Suggestion {
        ...
        /**
         * StyleKit: master switch for the Roman Urdu spell-correction provider.
         * When true, [dev.patrickgold.florisboard.stylekit.nlp.RomanUrduSuggestionProvider]
         * auto-detects, per composed word, whether it looks like Roman Urdu or
         * English, and offers corrections from whichever wordlist matches.
         */
        val romanUrduCorrectionEnabled = boolean(
            key = "suggestion__roman_urdu_correction_enabled",
            default = true,
        )
    }
