...
fun TypingScreen() = FlorisScreen {
    ...
    content {
        ...
        PreferenceGroup(title = "StyleKit — Adaptive Learning") {
            ...
            SwitchPreference(
                prefs.suggestion.romanUrduCorrectionEnabled,
                title = "Roman Urdu spelling correction",
                summary = "Auto-detects whether each word you type looks like Roman Urdu or " +
                    "English, and suggests corrections from the matching wordlist. Runs entirely " +
                    "on-device.",
                enabledIf = { prefs.suggestion.enabled isEqualTo true },
            )
        }
